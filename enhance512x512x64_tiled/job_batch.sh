...
mkdir ./visualize/val/mapped/input
mkdir ./visualize/val/mapped/output
mkdir ./visualize/val/mapped/target
...
mkdir ./visualize/test/mapped/input
mkdir ./visualize/test/mapped/ouptut
mkdir ./visualize/test/mapped/target
